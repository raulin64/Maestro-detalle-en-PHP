...
$(document).ready(function()
{
        ...
        $("td[name=ContribuyenteClave]").click(function () {    
...
<div align="center" style="position: absolute; bottom: 0; width:1000px; height: 500px;background-repeat: no-repeat; left: 70px">
  ...
  <table id="myTable" class="tablesorter">
    ...
    <tbody>
      ...
      <tr>
        <td style="display:none;" name="ContribuyenteClave" id="ContribuyenteClave"><?php echo $row["ContribuyenteClave"]; ?></td>
        <td name="ContribuyenteClave"><?php echo $row["Nombre"]; ?></td>
        <td name="ContribuyenteClave"><?php echo $row["Apellidos"]; ?></td>
        <td name="ContribuyenteClave"><?php echo $row["Dni"]; ?></td>
		<?php /*
